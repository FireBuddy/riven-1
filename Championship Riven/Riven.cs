    ...
    class Riven
    {
        ...
        private static void LastHit()
        {
                ...
                foreach (var Minion in Minions)
                    ...
                    if (tawah == null && ObjectManager.Player.Position.Distance(tawah.ServerPosition) < 800 && Minion != null && Prediction.Health.GetPrediction(Minion, 50) > Player.Instance.TotalAttackDamage && Prediction.Health.GetPrediction(Minion, 50) - Player.Instance.TotalAttackDamage - SpellQDamage(Minion, Minion.Health)  <= 0 )
